...
import type { ImageLayerClipboard } from "@/features/map-editor/types/editor-helpers";
 ...
 */
export function setImageLayerClipboard(data: ImageLayerClipboard | null): void {
