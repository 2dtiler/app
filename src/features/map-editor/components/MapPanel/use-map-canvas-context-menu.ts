...
import { pointHitsObjectBody } from "@/features/map-editor/components/MapCanvas/object-utils";
import { getMapCellAtPoint } from "@/features/map-editor/lib/map-geometry";
