...
import type { TideMissingResourcesDialogProps } from "@/types";

export function TideMissingResourcesDialog({
  open,
  onOpenChange,
  resources,
  selectedFileNames,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl" showCloseButton={!isSubmitting}>
        <DialogHeader>
          <DialogTitle>Resolve linked tIDE resources</DialogTitle>
          <DialogDescription>
            Select the missing image files referenced by this tIDE map. If a
            chosen file reveals more dependencies, this list will update after
            you continue.
          </DialogDescription>
        </DialogHeader>
