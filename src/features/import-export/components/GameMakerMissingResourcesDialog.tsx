...
export function GameMakerMissingResourcesDialog({
  open,
  onOpenChange,
  resources,
  selectedFileNames,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl" showCloseButton={!isSubmitting}>
        <DialogHeader>
          <DialogTitle>Resolve linked GameMaker resources</DialogTitle>
          <DialogDescription>
            Select the missing tileset resources and image files referenced by
            this GameMaker room. If a tileset file reveals additional linked
            images, this list will update after you continue.
          </DialogDescription>
        </DialogHeader>
