...
export function DefoldMissingResourcesDialog({
  open,
  onOpenChange,
  resources,
  selectedFileNames,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl" showCloseButton={!isSubmitting}>
        <DialogHeader>
          <DialogTitle>Resolve linked Defold resources</DialogTitle>
          <DialogDescription>
            Select the missing Defold tilemap, tilesource, or image files
            referenced by this import. If a linked resource reveals more
            dependencies, this list will update after you continue.
          </DialogDescription>
        </DialogHeader>
